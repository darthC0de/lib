      ...
      circle {
        &:nth-child(1) {
          ...
          ${props =>
            props.reverse
              ? css`
                  stroke: ${(propsData: ContainerProps) => {
                    const breaks = propsData.breakPoints || [0, 1, 30, 70, 90];
                    const colors = propsData.breakPointColors || [
                      'rgba(55, 239, 39, 1)',
                      'rgba(55, 239, 39, 0.3)',
                      'rgba(248, 205, 53, 1)',
                      'rgba(253, 244, 33, 1)',
                    ...
                    breaks.forEach((item, index) => {
                      if (propsData.progress >= item) colorIndex = index;
                    });
